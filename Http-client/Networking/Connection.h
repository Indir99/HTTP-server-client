...
public:
    ...
    Connection(owner parent, asio::io_context& asioContext, asio::ip::tcp::socket socket, Utilities::ThreadSafeQueue<OwnedMessage<T>>& qIn)
...
protected:
    ...
    // of this Connection
    Utilities::ThreadSafeQueue<Message<T>> m_qMessagesOut;
